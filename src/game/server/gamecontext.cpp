...
void CGameContext::ConAuthAccount(IConsole::IResult * pResult, void * pUser)
{
	...
	else
	{
		...
		str_copy(oldName, pSelf->Server()->ClientName(ClientID), MAX_NAME_LENGTH);
...
const char *CGameContext::AccSysVersion() { return GAME_ACCSYSVERSION; }
