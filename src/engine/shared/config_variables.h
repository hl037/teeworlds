...
MACRO_CONFIG_INT(SvRecordGamedata, sv_record_gamedata, 1, 0, 0, CFGFLAG_SERVER, "Record extra game data (like client net address) in a separate file when recording a demo")
